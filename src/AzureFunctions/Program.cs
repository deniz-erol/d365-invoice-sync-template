...
// External API Clients - managed by IHttpClientFactory
builder.Services.AddHttpClient<XeroInvoiceClient>();
builder.Services.AddHttpClient<QuickBooksInvoiceClient>();
